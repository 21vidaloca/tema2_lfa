x=open("dfa_config_file.txt","r").readlines()
# print(x)
n=len(x)
stari_finale=[]
dict={}
...
if(c>1):
    invalid=1
    print("aici#3")
# etapa 1 - verificare daca este dfa
estedfa=1
for x in dict:
    fr={}
    for ceva in dict[x]:
...
if(invalid==1):
    ...
    if(estedfa==1):
        print("automatul este dfa")
    else:
        print("automatul nu este dfa")

# etapa 2 - verificare string
# verificam sirul "cdbccedbdbae"(accept) sau "aecabccbdf"(reject)
sir="aecabccbdf"
ind=0
ok=0
n=len(sir)
# in dict avem muchiile
# stari_finale
print(dict)
# print(stari_finale)
